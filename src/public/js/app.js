...
async function handleCameraChange() { // 카메라가 두개 이상일 경우 쓰임...
...
// Welcome Form (join a room) // 완강 후 폼 다시하기

const welcome2 = document.getElementById("welcome2");
welcomeForm = welcome2.querySelector("form");
...
socket.on("offer", async (offer) => {
    ...
    const asnwer = await myPeerConnection.createAnswer();
    myPeerConnection.setLocalDescription(asnwer);
    socket.emit("answer", asnwer, roomName);
